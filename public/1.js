...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    plusSlides: function plusSlides() {
      var _this2 = this;

      this.$store.dispatch('plusImage').then(function () {
        ...
        _this2.iname = _this2.imagefile['image']['name'];
        _this2.iurl = _this2.imagefile['image']['url'];
      })["catch"](function (err) {
        console.log(err);
      });
    },
    minusSlides: function minusSlides() {
      var _this3 = this;

      this.$store.dispatch('minusImage').then(function () {
        _this3.imagefile = _this3.$store.getters.getCurrentImageData;
        _this3.comment = _this3.imagefile['image']['comment']; // in real i need to load the comment from the DB

        _this3.ex_comment = _this3.comment;
        _this3.iname = _this3.imagefile['image']['name'];
        _this3.iurl = _this3.imagefile['image']['url'];
      })["catch"](function (err) {
        console.log(err);
      });
    },
    ...
    save_comment: function save_comment() {
      ...
      this.$store.dispatch('save_comment', this.comment).then(function () {
    ...
    save_iname: function save_iname() {
      if (!this.readonly) {
        this.readonly = true;
        this.$store.dispatch('save_name', this.iname).then(function () {
    ...
    delete_image: function delete_image() {
      ...
      this.$store.dispatch('deleteImage').then(function () {
        _this4.imagefile = _this4.$store.getters.getCurrentImageData;
        _this4.comment = _this4.imagefile['image']['comment']; // in real i need to load the comment from the DB

        _this4.ex_comment = _this4.comment;
        _this4.iname = _this4.imagefile['image']['name'];
        _this4.iurl = _this4.imagefile['image']['url'];
      });
  ...
  created: function created() {
    ...
    this.$store.dispatch('getImages').then(function () {
      _this5.imagefile = _this5.$store.getters.getCurrentImageData;
      _this5.comment = _this5.imagefile['image']['comment']; // in real i need to load the comment from the DB

      _this5.ex_comment = _this5.comment;
      _this5.iname = _this5.imagefile['image']['name'];
      _this5.iurl = _this5.imagefile['image']['url']; //'https://cdn.vuetifyjs.com/images/carousel/squirrel.jpg';
      //   alert(this.iurl);
  ...
  return _c(
    ...
    [
      ...
      _c(
        ...
        [_c("img", { staticClass: "main-img", attrs: { src: _vm.iurl } })]
      ),
      _vm._v(" "),
      _c(
        "v-container",
              ...
              _c(
                ...
                [
                  _c(
                    "v-row",
                    [
                      _c("v-col", { staticClass: "col-md-2 noborder" }, [
                        _c("img", {
                          staticClass: "img-up",
                          attrs: { src: _vm.image }
                        })
